...
let api = function Binance( options = {} ) {
    ...
    const futuresOrderBuy = async ( side, positionSide, symbol, quantity, price = false, params = {} ) => {
        params.symbol = symbol;
        params.side = side;
    ...
    const futuresOrderClose = async ( side, positionSide, symbol, price = false, closePosition, params = {} ) => {
        params.symbol = symbol;
        params.side = side;
        params.positionSide = positionSide
   ...
   */
    ...
    return {
        ...
        */
        ...
        futuresMarketBuy: async ( side, positionSide, symbol, quantity, params = {} ) => {
            return futuresOrder( side, positionSide, symbol, quantity, false, params );
        },
        ...
        futuresMarketPositionOpen: async (side, positionSide, symbol, quantity, params = {}) => {
            return futuresOrderBuy( side, positionSide, symbol, quantity, false, params )
        },

        futuresMarketPositionClose: async (side, positionSide, symbol, params = {}) => {
            return futuresOrderClose( side, positionSide, symbol, false, closePosition, params )
        },
